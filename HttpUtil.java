package com.haishu.platform.common.util;
...
public class HttpUtil {
    ...
    public static void main(String[] args) {
        try {
            ...
            params.put("account", "data-exchange-root");
            params.put("password", "111111");


            // 登录
            String loginUrl = "http://10.100.1.18:20211/auth/signin/nosafe";
            String result1 = HttpUtil.post(loginUrl,JsonUtil.toJson(params));
